...
function renderPolicyIntroduction(policy){
  document.getElementById("surveySections").innerHTML = `
    ...
    <aside class="policy-simulation-notice">
      ...
      <p><strong>Simulation data</strong>All simulation data and results presented in this study were generated based on the source policy implementation plan.</p>
    </aside>`;
}
